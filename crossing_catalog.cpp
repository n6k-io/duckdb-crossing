...
static BinderException SchemasAreServed() {
...
static InternalException DmlBypassedTheWriteCatalog() {
...
static BinderException CreateNotSupported(const string &schema) {
